  ...
  <login-container>
    <div class="login-form">
      ...
      <el-form ref="formRef" label-position="left" :model="form" :rules="rules" @submit.prevent>
        ...
        <div class="title-tips">{{ title }} 忘记密码</div>
        ...
        <el-form-item prop="password">
          <el-input v-model.trim="form.password" clearable placeholder="请输入新密码" type="password">
            <template #prefix>
        ...
        <el-form-item prop="password2">
          <el-input v-model.trim="form.password2" clearable placeholder="请确认新密码" type="password">
            <template #prefix>
              <vab-icon icon="lock-line" />
            </template>
          </el-input>
        </el-form-item>
        <el-button v-throttle="handleRegister" class="login-btn" :loading="loading" native-type="submit" type="primary">修改密码</el-button>
        <router-link to="/login">
          <el-button style="margin-top: 20px; margin-left: -10px" type="primary">登录</el-button>
        </router-link>
        <router-link to="/register">
          <el-button style="margin-top: 20px" text type="primary">注册</el-button>
        </router-link>
      </el-form>
    </div>
  </login-container>
